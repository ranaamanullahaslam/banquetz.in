...
$location_dropdowns     = golo_get_option('location_dropdowns', 1);
...
$place_location     = get_post_meta( $place_data->ID, GOLO_METABOX_PREFIX . 'place_location', true );
$place_map_address  = isset($place_location['address']) ? $place_location['address'] : '';
$place_map_location = isset($place_location['location']) ? $place_location['location'] : '';
list( $lat, $lng )  = !empty($place_location['location']) ? explode( ',', $place_location['location'] ) : array('', '');

$place_timezone = get_post_meta( $place_data->ID, GOLO_METABOX_PREFIX . 'place_timezone', true);
?>
...
<div class="place-fields-wrap">
    <div class="place-fields place-city">
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <div class="form-group golo-loading-ajax-wrap">
                    ...
                    <select name="place_city" id="city" class="golo-place-city-ajax form-control nice-select wide">
                        ...
                        <?php golo_get_taxonomy_by_post_id( $place_data->ID, 'place-city', true, $default_city); ?>
                    </select>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <label class="place-fields-title"><?php esc_html_e('Create New City', 'golo-framework'); ?></label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select name="place_timezone" id="timezone" class="form-control nice-select wide">
                        <?php echo wp_timezone_choice( $place_timezone, 'UTC' ); ?>
                    </select>
                </div>
            </div>
        </div>
...
<div class="place-fields-wrap">
    <div class="place-fields place-address">
        <div class="form-group">
            ...
            <input type="text" id="search-location" class="form-control place-map-address" name="place_map_address" value="<?php echo esc_attr($place_map_address); ?>" id="search-location" placeholder="<?php esc_attr_e('Full address', 'golo-framework'); ?>">
            <input type="hidden" class="form-control place-map-location" name="place_map_location" value="<?php echo esc_attr($place_map_location); ?>"/>
...
<script>
    jQuery(document).ready(function () {
        ...
        if( maptype == 'google_map' ){
            ...
            var lat = parseFloat('59.327'), lng = parseFloat('18.067');
            ...
            map_location.setView([40.91, -96.63], 4);
            ...
            var osm_marker = new L.marker([40.91, -96.63], {draggable:'true'});
            ...
            function golo_my_location(map) {
                ...
                function CenterControl(controlDiv, map) {
                    ...
                    jQuery('.my-location').on('click', function(e) {
                        ...
                        osm_marker.setLatLng([parseFloat(my_lat), parseFloat(my_lng)]).addTo(map_location);
                            
                        map_location.flyTo([parseFloat(my_lat),parseFloat(my_lng)]);
