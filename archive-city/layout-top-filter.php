...
<div class="nav-bar <?php if( !empty($enable_city_map) ) { echo 'has-map'; } ?>">
    <div class="container">
        ...
        <div class="inner-nav-bar">
            ...
            <div class="left">
                ...
                <?php
                    if( in_array('open_time', $search_fields ) ) {
                ?>
                <div class="filter-open-time">
                    <a href="#" data-open="" class="">Open Now</a>
            ...
            <div class="top-area">
                ...
                <div class="entry-left">
                    <span class="result-count">
                        <?php printf( _n( '%s Place', '%s Places', $total_post, 'golo-framework' ), '<span class="count">' . esc_html( $total_post ) . '</span>' ); ?>
                    </span>
                </div>
